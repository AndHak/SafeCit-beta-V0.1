...
class Main(QMainWindow):
    ...
    def setup_ui(self):
        ...
        image = QPixmap(os.path.join(self.basedir, "images/fondo3.jpg"))
        image = image.scaled(900, 800)
    ...
    def setup_login_ui(self):
        ...
        self.bienvenido_label.setText("Bienvenido a SafeCit!")
    ...
    def setup_ui_register(self):
        ...
        self.unetenos_label.setText("SafeCit te mantiene seguro, Unete!")
